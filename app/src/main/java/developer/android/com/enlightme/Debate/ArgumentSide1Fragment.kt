...
class ArgumentSide1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.root.setOnLongClickListener{
            ...
            this.title = viewModel.debate.value?.getDebateEntity()?.side_1_entity?.get(this.place)?.title
            this.description = viewModel.debate.value?.getDebateEntity()?.side_1_entity?.get(this.place)?.description
